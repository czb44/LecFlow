...
def test_predict_labels_embed(housekeeping_model, sent_transformer):
    ...
    sentences = [
        (
            "Notice that the probability does not become ninety-five "
            "percent simply because the word is common in spam."
        ),
        (
            "The base rate of spam still matters, "
            "and the evidence must always be interpreted "
            "in the context of the prior information."
        ),
